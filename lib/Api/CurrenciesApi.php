...
class CurrenciesApi
{
    ...
    {
        list($response) = $this->indexCurrenciesWithHttpInfo();
        return $response;
    }

    /**
     * Operation indexCurrenciesWithHttpInfo
     *
     * Index currencies
     *
     *
    ...
    /**
     * Operation indexCurrenciesAsync
     *
     * Index currencies
     *
     *
     ...
     */
    public function indexCurrenciesAsync()
    {
        return $this->indexCurrenciesAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation indexCurrenciesAsyncWithHttpInfo
     *
     * Index currencies
     *
     *
    ...
    /**
     * Create request for operation 'indexCurrencies'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function indexCurrenciesRequest()
    {
    ...
    {
        list($response) = $this->resetCurrencyWithHttpInfo($currency_code);
        return $response;
    }

    /**
     * Operation resetCurrencyWithHttpInfo
     *
     * Reset existing currency
     *
     * @param  string $currency_code Currency code (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function resetCurrencyAsync($currency_code)
    {
        return $this->resetCurrencyAsyncWithHttpInfo($currency_code)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation resetCurrencyAsyncWithHttpInfo
     *
     * Reset existing currency
     *
     * @param  string $currency_code Currency code (required)
    ...
    /**
     * Create request for operation 'resetCurrency'
     *
     * @param  string $currency_code Currency code (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function resetCurrencyRequest($currency_code)
    {
        // verify the required parameter 'currency_code' is set
        if ($currency_code === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $currency_code when calling resetCurrency'
            );
        }

        $resourcePath = '/currency/{currencyCode}/reset';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->showCurrencyWithHttpInfo($currency_code);
        return $response;
    }

    /**
     * Operation showCurrencyWithHttpInfo
     *
     * Show single currency
     *
     * @param  string $currency_code Currency code (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function showCurrencyAsync($currency_code)
    {
        return $this->showCurrencyAsyncWithHttpInfo($currency_code)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation showCurrencyAsyncWithHttpInfo
     *
     * Show single currency
     *
     * @param  string $currency_code Currency code (required)
    ...
    /**
     * Create request for operation 'showCurrency'
     *
     * @param  string $currency_code Currency code (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function showCurrencyRequest($currency_code)
    {
        // verify the required parameter 'currency_code' is set
        if ($currency_code === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $currency_code when calling showCurrency'
            );
        }

        $resourcePath = '/currency/{currencyCode}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->updateCurrencyWithHttpInfo($currency_code, $body);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateCurrencyAsync($currency_code, $body)
    {
        return $this->updateCurrencyAsyncWithHttpInfo($currency_code, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateCurrencyRequest($currency_code, $body)
    {
        // verify the required parameter 'currency_code' is set
        if ($currency_code === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $currency_code when calling updateCurrency'
            );
        }
        // verify the required parameter 'body' is set
        if ($body === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling updateCurrency'
            );
        }
