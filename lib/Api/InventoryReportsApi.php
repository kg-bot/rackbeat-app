...
class InventoryReportsApi
{
    ...
    /**
     * Operation inventoryReportInventoryChecking
     *
    ...
    {
        list($response) = $this->inventoryReportInventoryCheckingWithHttpInfo($body);
        return $response;
    }

    /**
     * Operation inventoryReportInventoryCheckingWithHttpInfo
     *
     * Inventory report: inventory checking
     *
     * @param  \Swagger\Client\Model\InventoryCheckingReportForm $body Inventory checking filter object (required)
    ...
    /**
     * Operation inventoryReportInventoryCheckingAsync
     *
     * Inventory report: inventory checking
     *
     * @param  \Swagger\Client\Model\InventoryCheckingReportForm $body Inventory checking filter object (required)
     ...
     */
    public function inventoryReportInventoryCheckingAsync($body)
    {
        return $this->inventoryReportInventoryCheckingAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation inventoryReportInventoryCheckingAsyncWithHttpInfo
     *
     * Inventory report: inventory checking
     *
     * @param  \Swagger\Client\Model\InventoryCheckingReportForm $body Inventory checking filter object (required)
     ...
     */
    protected function inventoryReportInventoryCheckingRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling inventoryReportInventoryChecking'
            );
        }

        $resourcePath = '/inventory-reports/inventory-checking';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation inventoryReportInventoryLedger
     *
    ...
    {
        list($response) = $this->inventoryReportInventoryLedgerWithHttpInfo($body);
        return $response;
    }

    /**
     * Operation inventoryReportInventoryLedgerWithHttpInfo
     *
     * Inventory report: inventory ledger
     *
     * @param  \Swagger\Client\Model\InventoryLedgerReportForm $body Inventory ledger filter object (required)
    ...
    /**
     * Operation inventoryReportInventoryLedgerAsync
     *
     * Inventory report: inventory ledger
     *
     * @param  \Swagger\Client\Model\InventoryLedgerReportForm $body Inventory ledger filter object (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function inventoryReportInventoryLedgerAsync($body)
    {
        return $this->inventoryReportInventoryLedgerAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation inventoryReportInventoryLedgerAsyncWithHttpInfo
     *
     * Inventory report: inventory ledger
     *
     * @param  \Swagger\Client\Model\InventoryLedgerReportForm $body Inventory ledger filter object (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function inventoryReportInventoryLedgerRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling inventoryReportInventoryLedger'
            );
        }

        $resourcePath = '/inventory-reports/inventory-ledger';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation inventoryReportInventoryValuation
     *
    ...
    {
        list($response) = $this->inventoryReportInventoryValuationWithHttpInfo($body);
        return $response;
    }

    /**
     * Operation inventoryReportInventoryValuationWithHttpInfo
     *
     * Inventory report: inventory valuation
     *
     * @param  \Swagger\Client\Model\InventoryValuationReportForm $body Inventory valuation filter object (required)
    ...
    /**
     * Operation inventoryReportInventoryValuationAsync
     *
     * Inventory report: inventory valuation
     *
     * @param  \Swagger\Client\Model\InventoryValuationReportForm $body Inventory valuation filter object (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function inventoryReportInventoryValuationAsync($body)
    {
        return $this->inventoryReportInventoryValuationAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation inventoryReportInventoryValuationAsyncWithHttpInfo
     *
     * Inventory report: inventory valuation
     *
     * @param  \Swagger\Client\Model\InventoryValuationReportForm $body Inventory valuation filter object (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function inventoryReportInventoryValuationRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling inventoryReportInventoryValuation'
            );
        }

        $resourcePath = '/inventory-reports/inventory-valuation';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
