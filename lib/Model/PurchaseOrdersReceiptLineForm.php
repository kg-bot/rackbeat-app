...
/**
 * PurchaseOrdersReceiptLineForm Class Doc Comment
 *
 * @category Class
 * @package     Swagger\Client
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class PurchaseOrdersReceiptLineForm implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'purchase_orders_receipt_line_form';
    ...
    public function setProductId($product_id)
    {
        if ((strlen($product_id) > 50)) {
            throw new \InvalidArgumentException('invalid length for $product_id when calling PurchaseOrdersReceiptLineForm., must be smaller than or equal to 50.');
        }
