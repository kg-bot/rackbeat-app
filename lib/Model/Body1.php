...
class Body1 implements ModelInterface, ArrayAccess
{
    ...
    public function setNumber($number)
    {
        if (!is_null($number) && (strlen($number) > 50)) {
            throw new \InvalidArgumentException('invalid length for $number when calling Body1., must be smaller than or equal to 50.');
        }
    ...
    public function setName($name)
    {
        if (!is_null($name) && (strlen($name) > 80)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Body1., must be smaller than or equal to 80.');
        }
    ...
    public function setBarcode($barcode)
    {
        if (!is_null($barcode) && (strlen($barcode) > 50)) {
            throw new \InvalidArgumentException('invalid length for $barcode when calling Body1., must be smaller than or equal to 50.');
        }
