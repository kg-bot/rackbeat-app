...
class CustomerInvoiceList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'customer_invoice_list';
    ...
    protected static $swaggerTypes = [
        'orders' => '\RackbeatApp\Client\Model\CustomerInvoice[]',
        'total'  => 'int',
        'pages'  => 'int',
        'limit'  => 'int',
        'page'   => 'int'
     ...
     * Sets orders
     *
     * @param \RackbeatApp\Client\Model\CustomerInvoice[] $orders orders
     *
     * @return $this
     */
