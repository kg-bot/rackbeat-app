...
/**
 * OrderShipmentList Class Doc Comment
 *
 * @category Class
 * @package     RackbeatApp\Client
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class OrderShipmentList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'order_shipment_list';
    ...
    protected static $swaggerTypes = [
        'orders' => '\RackbeatApp\Client\Model\OrderShipment[]',
        'total'  => 'int',
        'pages'  => 'int',
        'limit'  => 'int',
        'page'   => 'int'
     ...
     * Sets orders
     *
     * @param \RackbeatApp\Client\Model\OrderShipment[] $orders orders
     *
     * @return $this
     */
