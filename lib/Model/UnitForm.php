 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class UnitForm implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'unit_form';
    ...
    {
        if ((strlen($name) > 80)) {
            throw new \InvalidArgumentException('invalid length for $name when calling UnitForm., must be smaller than or equal to 80.');
        }
