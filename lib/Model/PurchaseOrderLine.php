...
class PurchaseOrderLine implements ModelInterface, ArrayAccess
{
    ...
    public function setChildId($child_id)
    {
        if (!is_null($child_id) && (strlen($child_id) > 50)) {
            throw new \InvalidArgumentException('invalid length for $child_id when calling PurchaseOrderLine., must be smaller than or equal to 50.');
        }
    ...
    public function setName($name)
    {
        if (!is_null($name) && (strlen($name) > 80)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PurchaseOrderLine., must be smaller than or equal to 80.');
        }
