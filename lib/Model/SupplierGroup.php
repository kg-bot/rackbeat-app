...
/**
 * SupplierGroup Class Doc Comment
 *
 * @category Class
 * @package     RackbeatApp\Client
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SupplierGroup implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SupplierGroup';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (strlen($name) > 80)) {
            throw new \InvalidArgumentException('invalid length for $name when calling SupplierGroup., must be smaller than or equal to 80.');
        }
