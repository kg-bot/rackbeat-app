 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class WebhookForm implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'webhook_form';
    ...
    public function listInvalidProperties()
    {
        ...
        if ((strlen($this->container['event']) > 255)) {
    ...
    {
        if ((strlen($event) > 255)) {
            throw new \InvalidArgumentException('invalid length for $event when calling WebhookForm., must be smaller than or equal to 255.');
        }
