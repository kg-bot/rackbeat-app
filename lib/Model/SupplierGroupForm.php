...
/**
 * SupplierGroupForm Class Doc Comment
 *
 * @category Class
 * @package     RackbeatApp\Client
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SupplierGroupForm implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'supplier_group_form';
     ...
     * Sets supplier_id
     *
     * @param int $supplier_id Unique integer
     *
     * @return $this
     */
    ...
    {
        if ((strlen($name) > 80)) {
            throw new \InvalidArgumentException('invalid length for $name when calling SupplierGroupForm., must be smaller than or equal to 80.');
        }
