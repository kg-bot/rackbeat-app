...
/**
 * ProductsPhysical Class Doc Comment
 *
 * @category Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ProductsPhysical implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'products_physical';
     ...
     * Sets depth
     *
     * @param float $depth Allows up to 2 decimals. Must not use comma (,) but instead a period (.) for decimals.
     *
     * @return $this
     */
    ...
    public function setWeightUnit($weight_unit)
    {
        if (!is_null($weight_unit) && (strlen($weight_unit) > 30)) {
            throw new \InvalidArgumentException('invalid length for $weight_unit when calling ProductsPhysical., must be smaller than or equal to 30.');
        }
    ...
    public function setSizeUnit($size_unit)
    {
        if (!is_null($size_unit) && (strlen($size_unit) > 30)) {
            throw new \InvalidArgumentException('invalid length for $size_unit when calling ProductsPhysical., must be smaller than or equal to 30.');
        }
