...
/**
 * SupplierInvoiceLine Class Doc Comment
 *
 * @category Class
 * @package     RackbeatApp\Client
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SupplierInvoiceLine implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SupplierInvoiceLine';
     ...
     * Sets child_id
     *
     * @param string $child_id Should reference a product or lot number.
     *
     * @return $this
     */
    public function setChildId($child_id)
    {
        if (!is_null($child_id) && (strlen($child_id) > 50)) {
            throw new \InvalidArgumentException('invalid length for $child_id when calling SupplierInvoiceLine., must be smaller than or equal to 50.');
        }
     ...
     * Sets child_type
     *
     * @param string $child_type lot if is Lot and product if is Product
     *
     * @return $this
     */
     ...
     *
     * @param object $variations_formatted variations_formatted
     *
     * @return $this
     */
     ...
     *
     * @param object $product_variation product_variation
     *
     * @return $this
     */
