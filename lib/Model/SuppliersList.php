...
/**
 * SuppliersList Class Doc Comment
 *
 * @category Class
 * @package     RackbeatApp\Client
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SuppliersList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'suppliers_list';
    ...
    protected static $swaggerTypes = [
        'suppliers' => '\RackbeatApp\Client\Model\Supplier[]',
        'total'     => 'int',
        'pages'     => 'int',
        'limit'     => 'int',
        'page'      => 'int'
     ...
     * Sets suppliers
     *
     * @param \RackbeatApp\Client\Model\Supplier[] $suppliers suppliers
     *
     * @return $this
     */
