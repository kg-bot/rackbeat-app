 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class LotLine implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LotLine';
    ...
    public function setProductId($product_id)
    {
        if (!is_null($product_id) && (strlen($product_id) > 50)) {
            throw new \InvalidArgumentException('invalid length for $product_id when calling LotLine., must be smaller than or equal to 50.');
        }
    ...
    public function setName($name)
    {
        if (!is_null($name) && (strlen($name) > 80)) {
            throw new \InvalidArgumentException('invalid length for $name when calling LotLine., must be smaller than or equal to 80.');
        }
