...
/**
 * CustomerForm Class Doc Comment
 *
 * @category Class
 * @package     RackbeatApp\Client
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CustomerForm implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'customer_form';
    ...
    public function setLocale($locale)
    {
        if (!is_null($locale) && (strlen($locale) > 2)) {
            throw new \InvalidArgumentException('invalid length for $locale when calling CustomerForm., must be smaller than or equal to 2.');
        }
    ...
    public function setEan($ean)
    {
        if (!is_null($ean) && (strlen($ean) > 13)) {
            throw new \InvalidArgumentException('invalid length for $ean when calling CustomerForm., must be smaller than or equal to 13.');
        }
    ...
    public function setOurReference($our_reference)
    {
        if (!is_null($our_reference) && (strlen($our_reference) > 80)) {
            throw new \InvalidArgumentException('invalid length for $our_reference when calling CustomerForm., must be smaller than or equal to 80.');
        }
    ...
    public function setTheirReference($their_reference)
    {
        if (!is_null($their_reference) && (strlen($their_reference) > 80)) {
            throw new \InvalidArgumentException('invalid length for $their_reference when calling CustomerForm., must be smaller than or equal to 80.');
        }
    ...
    public function setAttention($attention)
    {
        if (!is_null($attention) && (strlen($attention) > 80)) {
            throw new \InvalidArgumentException('invalid length for $attention when calling CustomerForm., must be smaller than or equal to 80.');
        }
    ...
    public function setCompanyName($company_name)
    {
        if ((strlen($company_name) > 80)) {
            throw new \InvalidArgumentException('invalid length for $company_name when calling CustomerForm., must be smaller than or equal to 80.');
        }
    ...
    public function setAddressStreet($address_street)
    {
        if (!is_null($address_street) && (strlen($address_street) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address_street when calling CustomerForm., must be smaller than or equal to 255.');
        }
    ...
    public function setAddressStreet2($address_street2)
    {
        if (!is_null($address_street2) && (strlen($address_street2) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address_street2 when calling CustomerForm., must be smaller than or equal to 255.');
        }
    ...
    public function setAddressCity($address_city)
    {
        if (!is_null($address_city) && (strlen($address_city) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address_city when calling CustomerForm., must be smaller than or equal to 255.');
        }
    ...
    public function setAddressZipcode($address_zipcode)
    {
        if (!is_null($address_zipcode) && (strlen($address_zipcode) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address_zipcode when calling CustomerForm., must be smaller than or equal to 255.');
        }
    ...
    public function setAddressCountry($address_country)
    {
        if (!is_null($address_country) && (strlen($address_country) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address_country when calling CustomerForm., must be smaller than or equal to 255.');
        }
    ...
    public function setContactEmail($contact_email)
    {
        if (!is_null($contact_email) && (strlen($contact_email) > 80)) {
            throw new \InvalidArgumentException('invalid length for $contact_email when calling CustomerForm., must be smaller than or equal to 80.');
        }
