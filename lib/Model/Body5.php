...
class Body5 implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['settings_url'] = isset($data['settings_url']) ? $data['settings_url'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['settings_url'] === null) {
            $invalidProperties[] = "'settings_url' can't be null";
        }
     ...
     * Sets settings_url
     *
     * @param string $settings_url settings_url
     *
     * @return $this
     */
